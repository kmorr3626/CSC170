...
public class MazeWorld extends World
{
    ...
    public void populateMazeWorld() {
        ...
        SnakeHorizontal snakeHorizontal1 = new SnakeHorizontal();
        SnakeHorizontal snakeHorizontal2 = new SnakeHorizontal();
        SnakeVertical snakeVertical = new SnakeVertical();

        addObject(snakeHorizontal1, 313, 300);
        addObject(snakeHorizontal2, 480, 52);
        addObject(snakeVertical, 846, 530);
        
        addObject(new Timer(45), 110, 30);
    }
}
